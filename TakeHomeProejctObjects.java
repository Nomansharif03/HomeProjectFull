package TakeHomeProejctObjects;
...
public class TakeHomeProejctObjects {
	...
	public TakeHomeProejctObjects(WebDriver driver1){
		driver=driver1;
...
//				WBsheet.createRow(i+1);
	 ...
	 java.util.List<WebElement> image=driver.findElements(By.xpath("//div[@class='product-thumbnail product-item__thumbnail']")); 
			int count=1;
			...
			File file=new File("C:\\Users\\4390\\Desktop\\ExcelData\\Noman.xlsx");
