package TakeHomeProejctExecution;
...
import TakeHomeProejctObjects.TakeHomeProejctObjects;



public class TakeHomeProjectExecution {
	
	TakeHomeProejctObjects object;
	WebDriver driver;
	
	@BeforeTest
	public void chromepage() {
		driver = new ChromeDriver();
		object = new TakeHomeProejctObjects(driver);
